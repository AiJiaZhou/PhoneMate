 ...
 * 修改备注：
 */
public class PanelSettingBgAdapter
        extends BaseRecyclerView<PanelBgColorEntity,PanelSettingBgAdapter.ViewHolder>{

    public PanelSettingBgAdapter(List<PanelBgColorEntity> mList, Context mContext) {
    ...
    public void baseOnBingViewHolder(ViewHolder holder, int position,
                                     PanelBgColorEntity entity) {
        holder.mView.setBackgroundColor(entity.mColors[position]);
        if(entity.isSelect){
    ...
    class ViewHolder extends BaseRecyclerViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            ViewGroup.LayoutParams layoutParams=new ViewGroup.LayoutParams(
                    (WindowUtils.getWIndowWidth(itemView.getContext())/PanelBgColorEntity.mMaxNum)
